                        ...
                        children: [
                          ...
                          Center(
                            child: FlatButton(
                              ...
                              child: Text(
                                Provider.of<SinglePropertyProvider>(context).singleProperty.sellingType==0?Applocalizations.of(context).translate("for-rent"):Applocalizations.of(context).translate("for-sell"),
                                style: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 15,
                                  color: Colors.white,
